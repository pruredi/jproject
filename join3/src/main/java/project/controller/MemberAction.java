...
public class MemberAction {
	...
	public String member_idcheck(String memid, Model model) throws Exception {
		System.out.println("/member_idcheck.do");
		int result = memberService.checkMemberId(memid);
	...
	public String pwd_find_ok(@ModelAttribute MemberBean mem, HttpServletResponse response, Model model)
		...
		if (member == null) {// 값이 없는 경우
			...
			try {
				...
				email.setHtmlMsg("<p align = 'center'>비밀번호 찾기</p><br>" + "<div align = 'center'>비밀번호 2번째 비번"
						+ member.getPasswd2() + "</div>" + "<div align = 'center'>비밀번호 2번째 비번" + temPasswd2 + "</div>");
	...
	public String member_join_ok(MemberBean member, HttpServletRequest request, Model model) throws Exception {
	...
	public String pwd_change_ok(MemberBean member, HttpServletRequest request, HttpSession session, Model model)
			throws Exception {
...
//	@RequestMapping(value = "/member_edit.do", method = RequestMethod.POST)
	...
	public String member_edit_ok(MemberBean member, HttpServletRequest request, HttpSession session, Model model)
			throws Exception {
	...
	public String member_del_ok(@RequestParam("passwd1") String passwd1, HttpSession session) throws Exception {
